...
import com.anmolsoftwaredeveloper12345.qrcodescanner.listeners.FeatureClickHandler

import com.anmolsoftwaredeveloper12345.qrcodescanner.adapter.ScannedBarcodeContentAdapter
import com.anmolsoftwaredeveloper12345.qrcodescanner.adapter.ScannedBarcodeFeaturesAdapter
import com.anmolsoftwaredeveloper12345.qrcodescanner.database.BarcodeDatabase

import com.anmolsoftwaredeveloper12345.qrcodescanner.models.*
        ...
        val featuresAdapter=ScannedBarcodeFeaturesAdapter(object : FeatureClickHandler {
            override fun click(barcodefeature: BarcodeFeatures) {
                ...
                when(type){
                    ...
                    "Open"->{
                    ...
                    else    if(scannedBarcode.urlOfWebsite.contains("whatsapp://")){
                            FeaturesOptions().openWhatsApp(scannedBarcode.urlOfWebsite.split("phone=")[1],requireContext())
                        }
                        ...
                        else  if(scannedBarcode.urlOfWebsite.contains("instagram://")){
                            FeaturesOptions().openInstagram(scannedBarcode.urlOfWebsite.split("username=")[1],requireContext())
                        }
                    ...
                    "Send Email"->{
                        FeaturesOptions().composeEmail(scannedBarcode.email,scannedBarcode.subjectOfEmail,scannedBarcode.contentOfEmail,requireContext())
                    }
                    "add to contacts"->{
                        if(scannedBarcode.telephoneNumber!=""){
                            FeaturesOptions()
